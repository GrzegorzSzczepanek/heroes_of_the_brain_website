<script lang="ts">
  ...
  const contentPL = {
    ...
    quote:
      "Naszą misją jest stworzenie przestrzeni do innowacji w dziedzinie interfejsów mózg-komputer",
    quoteAuthor: "Zespół Heroes of the Brain",
    joinTeamTitle: "Dołącz do naszego zespołu",
    joinTeamDesc:
      "Jesteśmy zawsze otwarci na nowych członków zespołu pasjonujących się nowymi technologiami",
  ...
  const contentEN = {
    ...
    quote:
      "Our mission is to create space for innovation in the field of brain-computer interfaces",
    quoteAuthor: "Heroes of the Brain Team",
    joinTeamTitle: "Join our team",
    joinTeamDesc:
      "We are always open to new team members passionate about new technologies",
  ...
  const teamMembers = [
    {
      ...
      bio: "Anna has been organizing tech events for over 5 years and leads our coordination team.",
      image: "/images/placeholder-woman.jpg",
    },
    {
      name: "Piotr Nowak",
      role: "Technical Director",
      bio: "Expert in BCI technology with a background in computer science and neuroscience.",
      image: "/images/placeholder-man.jpg",
    },
    {
      name: "Marta Wiśniewska",
      role: "Marketing Lead",
      bio: "Marta handles our marketing strategy and social media presence.",
      image: "/images/placeholder-woman.jpg",
    },
    {
      name: "Adam Johnson",
      role: "Logistics Manager",
      bio: "Ensures everything runs smoothly during the event from venue to catering.",
      image: "/images/placeholder-man.jpg",
    },
    {
      name: "Joanna Smith",
      role: "Mentor Coordinator",
      bio: "PhD in Neuroscience who manages our mentor team and specialized workshops.",
      image: "/images/placeholder-woman.jpg",
    },
    {
      name: "Tomasz Brown",
      role: "Partner Relations",
      bio: "Works with our sponsors and partners to ensure mutual benefit and support.",
      image: "/images/placeholder-man.jpg",
    },
  ];
...
<svelte:head>
  ...
  <meta
    name="description"
    content="Meet the organizing team behind Heroes of the Brain 2025."
  />
  <meta
    name="keywords"
    content="organizers, team, heroes of the brain 2025, bci hackathon"
  />
                ...
                <div class="flex mt-4 space-x-3">
                  {#each ["linkedin", "twitter", "github"] as social}
                    ...
                    >
                      ...
                      >
                        <path
                          d="M12 0c-6.626 0-12 5.373-12 12 0 6.628 5.374 12 12 12 6.627 0 12-5.372 12-12 0-6.627-5.373-12-12-12zm5 17h-2v-6.999c0-1.92-.847-2.991-2.366-2.991-1.653 0-2.634 1.116-2.634 2.991v6.999h-2v-11h2v1.462c.58-.886 1.65-1.462 2.934-1.462 2.099 0 4.066 1.28 4.066 3.916v7.084zm-12-9.75v-2.5h2v2.5h-2z"
                        ></path>
                      </svg>
                    </a>
                  {/each}
