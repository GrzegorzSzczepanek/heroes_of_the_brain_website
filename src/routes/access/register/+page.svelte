...
<main class="flex flex-col items-center justify-center min-h-screen">
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" on:submit|preventDefault={register}>
        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2">
                Username:
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" bind:value={username} />
            </label>
        </div>
        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2">
