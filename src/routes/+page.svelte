<script lang="ts">
  ...
  const tPL = {
    ...
    registrationDate: "Zapisy otwarte",
    location: "Politechnika Wrocławska",
    prizes: "Pula o wartosci 21k w postaci nagród sprzetowych i pienieznych",
    applyNow: "Zgłoś się teraz",
    learnMore: "Dowiedz się więcej",
    partners: "Partnerzy",
    edition2025: "Interfejsy mózg-komputer w najnowszym wydaniu",
    edition2024:
      "Gdzie wszystko się zaczęło – spojrzenie na naszą pierwszą edycję",
    joinDesc:
      "Zostań częścią społeczności innowatorów pracujących nad przyszłością interakcji człowiek-komputer",
  ...
  const tEN = {
    ...
    registrationDate: "Registration open",
    location: "Wrocław University of Science and Technology",
    prizes: "Prize pool of 21k in the form of equipment and cash awards",
    applyNow: "Apply Now",
    ...
    joinDesc:
      "Become part of the community of innovators working on the future of human-computer interaction",
...
<svelte:head>
  <title>Heroes of the Brain</title>
  <meta name="description" content="Heroes of the Brain BCI Hackaton" />
  <meta
    name="keywords"
    content="brain, bci, hackaton, heroes, brainaccess, solet, pwr, politechnika wroclawska heroes of the brain heroesofthebrain politechnika hackaton neurohackaton"
  />
        ...
        <div class="text-white space-y-8">
          {#if visible}
            <div in:fade={{ duration: 800 }}>
              ...
              <p
                class="text-xl md:text-2xl text-purple-100 font-light mb-8 max-w-xl"
              >
                {tr.subtitle}
              </p>
  ...
  <section class="py-16 bg-gray-50">
    <div class="container mx-auto px-6">
      <div in:fade={{ duration: 800, delay: 300 }}>
        ...
        <p
          class="text-lg text-gray-700 max-w-3xl mx-auto text-center mt-6 mb-12"
        >
          {tr.aboutDesc}
        </p>
      </div>
              ...
              >
                <div class="relative">
                  ...
                  <div class="absolute top-4 right-4 z-10">
                    <span
                      class={`${edition.accent} text-white text-xs px-3 py-1 rounded-full font-medium`}
                    >
                      {edition.status}
                    </span>
                  </div>
                ...
                <div class="p-6">
                  ...
                  <div class="flex justify-end">
                    <span
                      class="text-purple-600 font-medium flex items-center hover:translate-x-1 transition-transform"
                    >
                      {tr.learnMore}
                      <svg
                        class="w-4 h-4 ml-1"
