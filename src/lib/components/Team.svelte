<script defer>
  ...
  Coordinator: [
    ...
    { name: 'Filip Puszko', role: 'Koordynator', imageUrl: '/images/sekcja_techniczna/filip_puszko.webp' },
    { name: "Dominika Serafin", role: 'Koordynator', imageUrl: '/images/sekcja_sponsorska/dominika_serafin.jpg' },
  ],
  Promotion: [
...
const teamsEN = {
  ...
  Coordinator: [
    ...
    { name: 'Paweł Dzikiewicz', role: 'Coordinator', imageUrl: '/images/koordynatorzy/pawel_dzikiewicz.webp' },
    ...
    {name: 'Filip Puszko', role: 'Coordinator', imageUrl: '/images/sekcja_techniczna/filip_puszko.webp' },
    { name: "Dominika Serafin", role: 'Coordinator', imageUrl: '/images/sekcja_sponsorska/dominika_serafin.jpg' },
  ],
  Promotion: [
