<script>
  ...
  export let isPolish;
  $: title = isPolish ? "Kontakt" : "Contact";
...
<section class="contact-section" id="contact">
  ...
  <div class="neural-bg">
    ...
    <div
      ...
      style="top: 10%; left: 20%; width: 250px; transform: rotate(20deg);"
    ></div>
    <div
      class="neural-connection"
      style="top: 30%; left: 10%; width: 350px; transform: rotate(-10deg);"
    ></div>
    <div
      class="neural-connection"
      style="top: 25%; left: 40%; width: 230px; transform: rotate(30deg);"
    ></div>
    <div
      class="neural-connection"
      style="top: 15%; left: 60%; width: 260px; transform: rotate(-20deg);"
    ></div>
    <div
      class="neural-connection"
      style="top: 50%; left: 15%; width: 250px; transform: rotate(40deg);"
    ></div>
    <div
      class="neural-connection"
      style="top: 60%; left: 35%; width: 380px; transform: rotate(-15deg);"
    ></div>
    <div
      class="neural-connection"
      style="top: 70%; left: 70%; width: 200px; transform: rotate(180deg);"
    ></div>
    <div
      class="neural-connection"
      style="top: 85%; left: 25%; width: 320px; transform: rotate(10deg);"
    ></div>
  </div>
    ...
    {#if visible}
      ...
      <div class="content-wrapper">
        ...
        <div class="map-wrapper" in:fly={{ y: 30, duration: 800, delay: 400 }}>
          <Map
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2504.9404734219456!2d17.055038176582062!3d51.10955843968897!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x470fe9d537a65c53%3A0xd3d8d644c240d69c!2sStrefa%20Otwartej%20Nauki!5e0!3m2!1spl!2spl!4v1731587787894!5m2!1spl!2spl"
          />
        </div>
      </div>
    {/if}
