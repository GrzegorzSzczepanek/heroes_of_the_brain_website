...
<section class="py-16 px-4" id="zapisy">
  <div class="max-w-6xl mx-auto">
    {#if visible}
      <div class="register-section" in:fade={{ duration: 800 }}>
        <!-- Neural background -->
        <div class="neural-bg">
        ...
        <div
          class="brain-pulse"
          style="bottom: 20%; right: 10%; animation-delay: 5s;"
        ></div>
        ...
        <div class="flex flex-col md:flex-row items-stretch p-4 md:p-8">
          ...
          >
            <div
              class="content-container h-full p-6 md:p-8 flex flex-col justify-between"
            >
              <div>
                <h2 class="section-title text-3xl md:text-4xl mb-6">
