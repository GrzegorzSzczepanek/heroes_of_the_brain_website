...
function embed(path, _options) {
    ...
    switch (parent.type) {
        ...
        case 'SnippetBlock':
            ...
            break;
        case 'Element':
            printJS$1(parent, (_f = options.svelteStrictMode) !== null && _f !== void 0 ? _f : false, false, false, 'tag');
            break;
        case 'MustacheTag':
...
const parsers = {
    svelte: {
        ...
        parse: (text) => {
            try {
                return Object.assign(Object.assign({}, compiler.parse(text)), { __isRoot: true });
            }
            catch (err) {
