...
let base = "/heroes_of_the_brain_website";
let assets = base;
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<!-- <link rel="icon" href="' + assets2 + '/favicon.png" /> -->\n		<link rel="icon" type="image/x-icon" href="https://knneuron.pwr.edu.pl/_next/image?url=http%3A%2F%2F127.0.0.1%3A1337%2Fuploads%2Fkn_neuron_logo_c3c1075271.png&w=640&q=75">\n		<link rel="stylesheet" href="https://unpkg.com/aos@next/dist/aos.css" />\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		<title>Hot Brain</title>\n		' + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover">\n		<div style="display: contents">' + body + `</div>
	</body>
	<script>
